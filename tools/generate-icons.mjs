...
render(
  `<!doctype html><meta charset=utf-8><body style="margin:0;background:#0c1016"><div style="width:512px;height:512px;display:flex;align-items:center;justify-content:center"><img src="file://${svg}" width=412 height=412></div></body>`,
